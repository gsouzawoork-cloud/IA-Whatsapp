...
const VARIANT_CLASSES: Readonly<Record<ButtonVariant, string>> = {
  primary:
    "bg-accent text-[#06231a] font-bold shadow-[0_6px_18px_-6px_rgba(105,217,164,0.55)] hover:bg-accent-hi hover:-translate-y-px active:translate-y-0 focus-visible:ring-accent/60",
  secondary:
